					...
					<table>
						...
						<p>
							...
							<input type="text" autofocus name="rut"
								value="<?php echo set_value('rut'); ?>" id="rut"
								placeholder="Rut" />
						</p>
						<p>
						...
						<p>
							...
							<input type="text" autofocus name="telefono"
								value="<?php echo set_value('telefono'); ?>" id="telefono"
						...
						<p>
							...
							<input type="text" autofocus name="genero"
								value="<?php echo set_value('genero'); ?>" id="Genero"
						...
						<p>
							...
							<input type="text" autofocus name="nacionalidad"
								value="<?php echo set_value('nacionalidad'); ?>"
						...
						<p>
							...
							<input type="text" autofocus name="estado_civil"
								value="<?php echo set_value('estado_civil'); ?>"
						...
						<p>
							...
							<input type="text" autofocus name="permiso"
								value="<?php echo set_value('permiso'); ?>" id="permiso"
						...
						<p>
							...
							<select name="usuario_departamento_id">
								...
								{
									?>
								<option value="<?php echo $datos->departamento_id?>"><?php echo $datos->departamento?></option>
								<?php }?>
							</select>
						</p>
